...
@Typed class FlushDb extends RedisCommand {
    static final ChannelBuffer FLUSHDB = ChannelBuffers.wrappedBuffer("flushdb\r\n".bytes)

    protected ChannelFuture write(Channel channel) {
        channel.write(FLUSHDB)
    }
