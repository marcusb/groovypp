...
@Typed
public class Issue229Test extends GroovyShellTestCase {
    void testMe () {
...
@Typed(debug = true)
void foo() {
    println ("Hello " + "world at " + System.currentTimeMillis())
}
foo()
"""
        }  finally {
        ...
        assert baos.toString().indexOf("DefaultGroovyMethods") < 0
    }
}