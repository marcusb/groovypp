...
public class KNucleotideGroovy {
  ...
  public static void main(String[] args) throws Exception {
    InputStream stream = KNucleotideGroovy.class.getClassLoader().getResourceAsStream("shootout/kNucleotide.class");
    String line;
    ...
    def futures = pool.invokeAll(createFragmentTasks(sequence, fragmentLengths));
    pool.shutdown();
    ...
    def nucleotideFragments = ["ggt", "ggta", "ggtatt", "ggtattttaatt", "ggtattttaatttatagt"]
